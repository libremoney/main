...
var Blockchain = function() {
	...
	return {
		...
		GetBlockIdAtHeight: GetBlockIdAtHeight,
		GetBlockIdsAfter: GetBlockIdsAfter,
		GetBlocks1: GetBlocks1,
		GetBlocks2: GetBlocks2,
		GetBlocksAfter: GetBlocksAfter,
		GetBlocksFromHeight: GetBlocksFromHeight,
		GetHeight: GetHeight,
		GetLastBlock: GetLastBlock,
		GetTransaction: GetTransaction,
		GetTransactionByFullHash: GetTransactionByFullHash,
		GetTransactionCount: GetTransactionCount,
		GetTransactions1: GetTransactions1,
		GetTransactions2: GetTransactions2,
		GetTransactions3: GetTransactions3,
		HasBlock: HasBlock,
		HasTransaction: HasTransaction,
		HasTransactionByFullHash: HasTransactionByFullHash,
		Init: Init,
		SetLastBlock1: SetLastBlock1,
		SetLastBlock2: SetLastBlock2,
