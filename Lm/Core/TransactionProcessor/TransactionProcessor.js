...
var TransactionProcessor = function() {
	...
	return {
		...
		Apply: Apply,
		ApplyUnconfirmed: ApplyUnconfirmed,
		Broadcast: Broadcast,
		Clear: Clear,
		Event: Event,
		GetAllUnconfirmedTransactions: GetAllUnconfirmedTransactions,
		...
		ProcessPeerTransactions1: ProcessPeerTransactions1,
		ProcessPeerTransactions2: ProcessPeerTransactions2,
		ProcessTransactions: ProcessTransactions,
		RemoveListener: RemoveListener,
		RemoveUnconfirmedTransactions: RemoveUnconfirmedTransactions,
		Shutdown: Shutdown,
		Undo: Undo,
		UndoAllUnconfirmed: UndoAllUnconfirmed,
		UpdateUnconfirmedTransactions: UpdateUnconfirmedTransactions
	}
}();
