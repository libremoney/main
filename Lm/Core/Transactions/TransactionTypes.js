	...
	function Find(type, subtype) {
		...
		switch (type) {
			case Constants.TrTypePayment:
				...
				break;
			case Constants.TrTypeMessaging:
				switch (subtype) {
					/*
				...
				break;
			case Constants.TrTypeColoredCoins:
				switch (subtype) {
					/*
				...
				break;
			case Constants.TrTypeDigitalGoods:
				switch (subtype) {
					/*
				...
				break;
			case Constants.TrTypeAccountControl:
				switch (subtype) {
					/*
