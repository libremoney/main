...
var Transactions = function() {
	...
	*/
	...
	function ParseTransaction1(bytes) {
		...
		TransactionType transactionType = TransactionTypes.Find(type, subtype);
	...
	return {
		...
		Init: Init,
		NewEncryptToSelfMessage1: NewEncryptToSelfMessage1,
		NewEncryptToSelfMessage2: NewEncryptToSelfMessage2,
		NewEncryptToSelfMessage3: NewEncryptToSelfMessage3,
		NewTransactionBuilder: NewTransactionBuilder,
		ParseEncryptToSelfMessage: ParseEncryptToSelfMessage,
		ParseTransaction1: ParseTransaction1,
		ParseTransaction2: ParseTransaction2,
		Types: TransactionTypes,

		DeleteTransactions: TransactionDb.DeleteTransactions,
		FindTransaction: TransactionDb.FindTransaction,
		FindTransactionByFullHash: TransactionDb.FindTransactionByFullHash,
		HasTransaction: TransactionDb.HasTransaction,
		HasTransactionByFullHash: TransactionDb.HasTransactionByFullHash,
		LoadTransaction: TransactionDb.LoadTransaction,
		FindBlockTransactions: TransactionDb.FindBlockTransactions,
		SaveTransaction: TransactionDb.SaveTransaction,
		SaveTransactions: TransactionDb.SaveTransactions
	}
}();
