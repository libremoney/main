...
var Crypto = function() {
	...
	*/
	...
	function GetPublicKey(secretPhrase) {
		try {
			var secretPhraseHash = Curve.Sha256(secretPhrase);
			return Curve.DerivePublicKeyWithClamp(secretPhraseHash);
		} catch (e) {
	...
	return {
		...
		RsEncode: RsEncode,
		Sha256: Sha256,
		Sha256Mesage: Sha256Mesage,
		Sign: Sign,
		Verify: Verify,
		XorDecrypt: XorDecrypt,
		XorEncrypt: XorEncrypt,
		XorProcess: XorProcess
	}
}();
