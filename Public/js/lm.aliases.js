			...
			if (response.aliases && response.aliases.length) {
				...
				for (var i = 0; i < alias_count; i++) {
					...
					rows += "<tr" + (alias.tentative ? " class='tentative'" : "") + " data-alias='" +
						...
						"<td class='uri'>" + (alias.aliasURI.indexOf("http") === 0 ?
						...
						"<a class='btn btn-xs btn-default' href='#' data-toggle='modal' data-target='#transfer_alias_modal' data-alias='" +
						String(alias.aliasName).escapeHTML() + "'>" + $.t("transfer") + "</a> " +
						...
						(allowCancel ? " <a class='btn btn-xs btn-default cancel_alias_sale' href='#' data-toggle='modal' " +
							"data-target='#cancel_alias_sale_modal' data-alias='" +
							String(alias.aliasName).escapeHTML() + "'>" + $.t("cancel_sale") + "</a>" : "") +
						"</td></tr>";
		...
		if (Lm.CurrentPage == "aliases") {
			...
			if ($row.length) {
				...
				var rowToAdd = "<tr class='tentative' data-alias='" + data.aliasName.toLowerCase() + "'>" +
					"<td class='alias'>" + data.aliasName + "</td>" +
					"<td class='uri'>" + (data.aliasURI && data.aliasURI.indexOf("http") === 0 ?
						"<a href='" + data.aliasURI + "' target='_blank'>" +
